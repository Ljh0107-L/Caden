...
/// A daemon on this Mac's own loopback.
...
/// Forget a server: the entry, its token, and the forward this Mac was
/// holding open to it. The daemon on the machine is left running -- removing
/// it from the list is not the same as tearing it down, and a session that is
/// mid-turn there should survive being taken off this Mac's screen.
...
function buildProvisionScript(home, files, port, restart, secrets = null) {
...
module.exports = {
  ...
  buildProvisionScript, providerSecrets, provision, shutdown,
